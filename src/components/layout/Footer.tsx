  ...
  return (
    <footer className="border-t border-white/8 bg-ink">
      <Container className="py-14">
        <div className="grid gap-10 md:grid-cols-[1.6fr_1fr_1fr]">
          <div>
            ...
            <a
              ...
              className="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-cyan hover:underline"
            >
          ...
          {cols.map((col) => (
            <div key={col.heading}>
              <h4 className="mb-4 text-sm font-semibold uppercase tracking-wider text-ink-muted">
                {col.heading}
              </h4>
              <ul className="space-y-2.5">
                {col.links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="text-[15px] text-ink-text/85 hover:text-cyan"
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        <div className="mt-12 flex flex-col items-start justify-between gap-3 border-t border-white/8 pt-6 text-sm text-ink-muted sm:flex-row sm:items-center">
